...
define('LOGIN_TITLE', 'Connexion à votre compte');
...
define('CONFIRM_NEW_PASSWORD_ERROR','La confirmation du mot de passe n\'est pas valide');
define('DELETE_USER_SUCCESS', 'Votre compte à bien était supprimé');
define('DELETE_USER_ERROR', 'Votre compte n\'a pas pu être supprimé');